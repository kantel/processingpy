...
# Titel
plot_title = u"Begrenztes Wachstum"
...
y_min = 0
y_max = 50
stepsize_x = 1    # Ticks auf der x-Achse
stepsize_y = -10  # Ticks auf der y-Achse

r = 0.5 # Wachstumsrate
K = 50  # Kapazitätsgrenze

def setup():
    size(WIDTH, HEIGHT)
    this.surface.setTitle("Begrenztes Wachstum")
